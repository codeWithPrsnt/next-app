...
const SearchName = () => {
    ...
    const handleClick = () => {
        ...
        if (option === 'All' || option === 'Nationality') {
    ...
    return (<>
        ...
        <div className="mb-6 flex w-[50%] ml-[25%]">
            ...
            <select title='choice' onChange={(e) => setOption(e.target.value)} id="colours" className="text-white mx-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
